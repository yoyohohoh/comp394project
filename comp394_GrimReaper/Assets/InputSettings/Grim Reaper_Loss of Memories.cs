...
public partial class @GrimReaper_LossofMemories: IInputActionCollection2, IDisposable
{
    ...
    ~@GrimReaper_LossofMemories()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, GrimReaper_LossofMemories.Player.Disable() has not been called.");
    }
